...
class VisualizationService:
    ...
    def get_player_image():
        return pygame.image.load(ASSETS_DIR / "cookie.png").convert_alpha()
    ...
    def get_holding_gift_image():
        return pygame.image.load(MENU_DIR / "cookie.png").convert_alpha()
    ...
    def load_main_game_displays():
        pygame.display.set_caption("Save The Cookie")
    ...
    def draw_author_credits(screen):
        ...
        author_credits = credit_font.render("©GDCOCOS 2023", True, (0, 0, 0))
    ...
    def draw_best_score(screen, max_score):
        ...
        best_score = score_font.render(f"Best: {max_score}", True, (255, 255, 255))
        best_score_rect = best_score.get_rect(center=(Config.WIDTH // 2, 240))
